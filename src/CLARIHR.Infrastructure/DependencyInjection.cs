...
using CLARIHR.Infrastructure.EmployeeRelations;
using CLARIHR.Infrastructure.Leave;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IOvertimeJustificationTypeRepository, OvertimeJustificationTypeRepository>();
        ...
        services.AddScoped<IPayrollCalculationDataProvider, PayrollCalculationDataProvider>();
        ...
        services.AddScoped<IPersonnelTransactionRepository, PersonnelTransactionRepository>();
        ...
        services.AddScoped<IReportExportHandler, SalaryTabulatorExportHandler>();
        services.AddScoped<IReportExportHandler, CostCentersExportHandler>();
        services.AddScoped<IReportExportHandler, LegalRepresentativesExportHandler>();
        services.AddScoped<IReportExportHandler, JobProfileCompetencyMatrixExportHandler>();
