...
using CLARIHR.Infrastructure.PersonnelEducationCatalogs;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<ITenantLocaleResolver, TenantLocaleResolver>();
        ...
        services.AddScoped<IPersonnelEducationCatalogRepository, PersonnelEducationCatalogRepository>();
