...
internal sealed class PersonnelFileDocumentConfiguration : IEntityTypeConfiguration<PersonnelFileDocument>
{
    public void Configure(EntityTypeBuilder<PersonnelFileDocument> builder)
    {
        ...
        builder.Property(item => item.FileData).HasColumnName("file_data");
...
internal sealed class PersonnelCatalogItemConfiguration : IEntityTypeConfiguration<PersonnelCatalogItem>
{
    public void Configure(EntityTypeBuilder<PersonnelCatalogItem> builder)
    {
        builder.ToTable("personnel_catalog_items");
        ...
        builder.Property(item => item.TenantId).HasColumnName("tenant_id");
        builder.Property(item => item.PublicId).HasColumnName("public_id");
        builder.Property(item => item.Category).HasColumnName("category").HasMaxLength(80);
        ...
        builder.Property(item => item.Name).HasColumnName("name").HasMaxLength(150);
        builder.Property(item => item.NormalizedName).HasColumnName("normalized_name").HasMaxLength(150);
        ...
        builder.HasIndex(item => new { item.TenantId, item.Category, item.IsActive, item.SortOrder })
