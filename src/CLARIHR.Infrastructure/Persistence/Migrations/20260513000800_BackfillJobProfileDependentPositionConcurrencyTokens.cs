...
namespace CLARIHR.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260513000800_BackfillJobProfileDependentPositionConcurrencyTokens")]
    public partial class BackfillJobProfileDependentPositionConcurrencyTokens : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                ...
                BEGIN
                    IF EXISTS (
                        ...
                        WHERE table_schema = current_schema()
                          AND table_name = 'job_profile_dependent_positions'
                        ...
                        ALTER TABLE job_profile_dependent_positions
                ...
                UPDATE job_profile_dependent_positions
