...
namespace CLARIHR.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260513000300_BackfillJobProfileRelationConcurrencyTokens")]
    public partial class BackfillJobProfileRelationConcurrencyTokens : Migration
    {
        /// <inheritdoc />
                ...
                BEGIN
                    IF EXISTS (
                        ...
                        WHERE table_schema = current_schema()
                          AND table_name = 'job_profile_relations'
                        ...
                        ALTER TABLE job_profile_relations
                        RENAME COLUMN "ConcurrencyToken" TO concurrency_token;
                    END IF;
                END $$;

                UPDATE job_profile_relations
