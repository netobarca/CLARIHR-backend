...
namespace CLARIHR.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260402201000_AddCompanySubscriptionPlanChanges")]
    partial class AddCompanySubscriptionPlanChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CLARIHR.Domain.Companies.CompanySubscriptionPlanChange", b =>
                {
                    ...
                    b.HasIndex("CurrentCommercialPlanId");

                    b.HasIndex("CurrentCommercialPlanVersionId");
            ...
            modelBuilder.Entity("CLARIHR.Domain.Companies.CompanySubscriptionPlanChange", b =>
                {
                    ...
                    b.HasOne("CLARIHR.Domain.Companies.CommercialPlan", null)
                        .WithMany()
                        .HasForeignKey("CurrentCommercialPlanId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_company_subscription_plan_changes__current_commercial_plans");

                    b.HasOne("CLARIHR.Domain.Companies.CommercialPlanVersion", null)
                        .WithMany()
                        .HasForeignKey("CurrentCommercialPlanVersionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_company_subscription_plan_changes__current_plan_versions");
