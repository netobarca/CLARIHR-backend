...
namespace CLARIHR.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260513000500_BackfillJobProfileTrainingConcurrencyTokens")]
    public partial class BackfillJobProfileTrainingConcurrencyTokens : Migration
    {
        /// <inheritdoc />
                ...
                BEGIN
                    IF EXISTS (
                        ...
                        WHERE table_schema = current_schema()
                          AND table_name = 'job_profile_trainings'
                        ...
                        ALTER TABLE job_profile_trainings
