...
namespace CLARIHR.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260513000700_BackfillJobProfileWorkingConditionConcurrencyTokens")]
    public partial class BackfillJobProfileWorkingConditionConcurrencyTokens : Migration
    {
        /// <inheritdoc />
                ...
                BEGIN
                    IF EXISTS (
                        ...
                        WHERE table_schema = current_schema()
                          AND table_name = 'job_profile_working_conditions'
