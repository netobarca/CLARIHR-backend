...
internal sealed class PersonnelFileRepository(ApplicationDbContext dbContext, IMemoryCache memoryCache) : IPersonnelFileRepository
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return normalizedCategory switch
        {
            ...
            "CURRICULUMMEDICALCLAIMTYPE" => await GetCountryScopedCatalogItemsAsync<MedicalClaimTypeCatalogItem>(countryCatalogItemId.Value, "CurriculumMedicalClaimType", cancellationToken),
            "CURRICULUMMEDICALCLAIMSTATUS" => await GetCountryScopedCatalogItemsAsync<MedicalClaimStatusCatalogItem>(countryCatalogItemId.Value, "CurriculumMedicalClaimStatus", cancellationToken),
            ...
            "BANKACCOUNTTYPE" => await GetCountryScopedCatalogItemsAsync<BankAccountTypeCatalogItem>(countryCatalogItemId.Value, "BankAccountType", cancellationToken),
            ...
            "ONETIMEDEDUCTIONSTATUS" => await GetCountryScopedCatalogItemsAsync<OneTimeDeductionStatusCatalogItem>(countryCatalogItemId.Value, "OneTimeDeductionStatus", cancellationToken),
            "NOTWORKEDTIMESTATUS" => await GetCountryScopedCatalogItemsAsync<NotWorkedTimeStatusCatalogItem>(countryCatalogItemId.Value, "NotWorkedTimeStatus", cancellationToken),
            "RECURRINGDEDUCTIONSTATUS" => await GetCountryScopedCatalogItemsAsync<RecurringDeductionStatusCatalogItem>(countryCatalogItemId.Value, "RecurringDeductionStatus", cancellationToken),
            "RECURRINGDEDUCTIONSETTLEMENTACTION" => await GetCountryScopedCatalogItemsAsync<RecurringDeductionSettlementActionCatalogItem>(countryCatalogItemId.Value, "RecurringDeductionSettlementAction", cancellationToken),
        ...
        CancellationToken cancellationToken)
    {
        ...
        return normalizedCategory switch
        {
            ...
            "CURRICULUMMEDICALCLAIMTYPE" => await IsCountryScopedCatalogCodeActiveAsync<MedicalClaimTypeCatalogItem>(companyCountry.CountryCatalogItemId, normalizedCode, cancellationToken),
            "CURRICULUMMEDICALCLAIMSTATUS" => await IsCountryScopedCatalogCodeActiveAsync<MedicalClaimStatusCatalogItem>(companyCountry.CountryCatalogItemId, normalizedCode, cancellationToken),
            ...
            "BANKACCOUNTTYPE" => await IsCountryScopedCatalogCodeActiveAsync<BankAccountTypeCatalogItem>(companyCountry.CountryCatalogItemId, normalizedCode, cancellationToken),
            ...
            "ONETIMEDEDUCTIONSTATUS" => await IsCountryScopedCatalogCodeActiveAsync<OneTimeDeductionStatusCatalogItem>(companyCountry.CountryCatalogItemId, normalizedCode, cancellationToken),
            "NOTWORKEDTIMESTATUS" => await IsCountryScopedCatalogCodeActiveAsync<NotWorkedTimeStatusCatalogItem>(companyCountry.CountryCatalogItemId, normalizedCode, cancellationToken),
            "RECURRINGDEDUCTIONSTATUS" => await IsCountryScopedCatalogCodeActiveAsync<RecurringDeductionStatusCatalogItem>(companyCountry.CountryCatalogItemId, normalizedCode, cancellationToken),
            "RECURRINGDEDUCTIONSETTLEMENTACTION" => await IsCountryScopedCatalogCodeActiveAsync<RecurringDeductionSettlementActionCatalogItem>(companyCountry.CountryCatalogItemId, normalizedCode, cancellationToken),
