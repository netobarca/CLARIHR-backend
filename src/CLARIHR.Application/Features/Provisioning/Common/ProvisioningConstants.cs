...
public static class ProvisioningConstants
{
    ...
    [
        ...
        new("PersonnelFiles.ViewComplianceReports", "Ver reportes legales de planilla", "Consulta y descarga de los reportes legales de planilla: F-14, Planilla Unica y Planilla Patronal (REQ-016).", PersonnelFilesModuleKey, "PersonnelFiles", "ViewComplianceReports"),
