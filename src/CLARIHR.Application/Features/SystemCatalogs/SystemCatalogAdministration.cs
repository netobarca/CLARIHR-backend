...
internal static class SystemCatalogFactory
{
    public static CountryScopedCatalogItem Create(
        ...
        => catalogType switch
        {
            ...
            SystemCatalogType.EducationStatus => EducationStatusCatalogItem.Create(countryCatalogItemId, countryCode, code, name, sortOrder),
            SystemCatalogType.EducationStudyType => EducationStudyTypeCatalogItem.Create(countryCatalogItemId, countryCode, code, name, sortOrder),
            SystemCatalogType.EducationCareer => EducationCareerCatalogItem.Create(countryCatalogItemId, countryCode, code, name, sortOrder),
            SystemCatalogType.EducationShift => EducationShiftCatalogItem.Create(countryCatalogItemId, countryCode, code, name, sortOrder),
            SystemCatalogType.EducationModality => EducationModalityCatalogItem.Create(countryCatalogItemId, countryCode, code, name, sortOrder),
