...
public static class CompanyTypeCatalog
{
    ...
    [
        Create(-8100, "SV", "SA_DE_CV", "Sociedad Anónima de Capital Variable", "Sociedad mercantil con capital representado en acciones y posibilidad de variación de capital.", 10),
        ...
        Create(-8102, "SV", "INDIVIDUAL_ENTERPRISE", "Empresa Individual", "Operación empresarial inscrita a nombre de una sola persona.", 30),
        Create(-8103, "SV", "COOPERATIVE", "Cooperativa", "Entidad asociativa organizada bajo el régimen cooperativo.", 40),
        Create(-8104, "SV", "ASSOCIATION", "Asociación", "Entidad asociativa sin fines de lucro reconocida legalmente.", 50),

        Create(-8200, "MX", "SA_DE_CV", "Sociedad Anónima de Capital Variable", "Sociedad mercantil mexicana con capital representado en acciones.", 10),
        ...
        Create(-8204, "MX", "AC", "Asociación Civil", "Persona moral de naturaleza civil sin fines preponderantemente mercantiles.", 50),
