...
public sealed class CoreJwtIntegrationTestWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    private readonly SemaphoreSlim _resetLock = new(1, 1);
    private readonly string _connectionString;

    public CoreJwtIntegrationTestWebApplicationFactory()
    {
