...
public sealed partial class ApiIntegrationTests
{
    ...
    private async Task<string> SeedCompensationConceptAsync(Guid tenantId, string code, string name, CompensationNature nature)
    {
        ...
        var concept = CompensationConceptTypeCatalogItem.Create(
            ...
            defaultIncomeClass: nature == CompensationNature.Ingreso ? IncomeClass.Otro : null,
            affectsIsss: nature == CompensationNature.Ingreso,
            affectsAfp: nature == CompensationNature.Ingreso,
            affectsRenta: nature == CompensationNature.Ingreso,
