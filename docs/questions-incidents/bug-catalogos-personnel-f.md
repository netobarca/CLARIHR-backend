...
| `delivery-statuses` | Activos y accesos → "Estado" | opcional |
...
1. **Sembrar** `asset-access-types` y `delivery-statuses` (SV, y demás países activos) vía migración, como se hizo con `assignment-types`.
