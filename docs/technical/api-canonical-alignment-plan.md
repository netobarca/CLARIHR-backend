...
| 2 | Company / Users / Preferences | 4 | **3/4** — CompanyPreferences ✅ (`9c970df`); UserPreferences ✅ (`5d54281`); AccountCompanies ✅ (migración generada, usuario aplica); CompanyUsers ⏸️ spike (diferido) |
