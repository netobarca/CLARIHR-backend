...
| 3 | Backoffice & catálogos | 6 | **1/6 — EN PROGRESO**: PR de infra ✅ (proyecto compartido `CLARIHR.Api.Common`, commiteado); **DocumentTypeCatalogs ✅** (piloto; build 0/0, unit 1467/0, integration 336/0/24). Cero migraciones. Siguiente: `JobProfileCatalogTypes`. |
