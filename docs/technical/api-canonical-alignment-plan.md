...
| 1 | Estructura org. & Locations | 7 | 4/7 ✅ WorkCenters + WorkCenterTypes + LocationGroups + LocationLevels (build 0/0, unit 1354/0, integration 294/0/24) — falta LocationHierarchy (singleton) para cerrar sub-dominio Locations; quedan OrgUnits + LegalRepresentatives |
