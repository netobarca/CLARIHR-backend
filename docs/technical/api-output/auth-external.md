...
- Este endpoint no crea empresa ni representante legal
- La empresa inicial y empresas adicionales se crean con `POST /api/account/companies`
- El cambio de empresa activa se realiza con `POST /api/account/companies/{companyId}/switch`
