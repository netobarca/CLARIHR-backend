...
|---|---|---|---|---|---|---|---|
| HU-2026-04-13-02 | Preview de validacion previa a finalize de expediente | Personnel Files / Employment | Implementada | 2026-04-13 | `docs/analysis/changes/HU-2026-04-13-02.md` | `docs/technical/api/openapi.yaml`, `docs/technical/api/endpoint-reference.md`, `docs/business/current-system-business-flows.md` | Agrega `GET /api/v1/personnel-files/{id}/finalize/preview` con `isEligible + issues` y reutiliza la logica de elegibilidad del `finalize` para evitar divergencia de reglas. |
