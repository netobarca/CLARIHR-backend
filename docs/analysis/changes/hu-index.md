...
|---|---|---|---|---|---|---|---|
| HU-2026-03-30-02 | OrgUnits expone referencia compacta del padre en lecturas | Core API / OrgUnits | Implementada | 2026-03-30 | `docs/analysis/changes/HU-2026-03-30-02.md` | `docs/technical/api/endpoint-reference.md` | Enriquece `OrgUnitResponse` con `parent { id, code, name }` reutilizando el mismo `LEFT JOIN` ya existente y sin agregar queries extra por fila. |
