...
La fase de Organización son **8 controladores** que modelan **dos estructuras independientes** de la
...
Position Slots. Tiene su propio `/usage` para ver dónde se usa antes de inactivar.
...
1. **Cost Centers** — independiente; lo van a referenciar las unidades.
2. **Org Structure Catalogs** (`unit-types`, `functional-areas`) — antes de las unidades.
3. **Organization Units** — el organigrama (usa los catálogos + cost centers).
4. **Location Hierarchy** (ya existe) → **Location Levels** → **Location Groups**.
5. **Work Center Types** → **Work Centers** (cuelgan de groups + types).
